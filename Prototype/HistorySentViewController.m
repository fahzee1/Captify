...
- (void)fetchUpdates
{
    if (!self.pendingRequest){
        ...
        NSDate *lastFetch = [[NSUserDefaults standardUserDefaults] valueForKey:@"lastSentFetch"];
        [[NSUserDefaults standardUserDefaults] setValue:[NSDate date] forKey:@"lastSentFetch"];
